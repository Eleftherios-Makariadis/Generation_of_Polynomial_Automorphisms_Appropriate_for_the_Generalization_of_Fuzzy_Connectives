...
switch ch
    case 1
        ...
        figure('Name','Graph of the generalized strong fuzzy negation','NumberTitle','off');
        fplot (N, [0 1], "b");
    ...
    case 2
        ...
        figure('Name','Graph of the generalized T-Norm','NumberTitle','off');
        surf(x, y, z);
    case 3
        ...
        figure('Name','Graph of the generalized S-conorm','NumberTitle','off');
        surf(x, y, z);
    case 4
        ...
        figure('Name','Graph of the generalized I-Implication','NumberTitle','off');
        surf(x, y, z);
end